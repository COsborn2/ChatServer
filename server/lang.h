...
#define LANG_WELCOME "Server: Welcome to E-Chat."
#define LANG_DISCONNECT "Server: %s has left the room."
#define LANG_BAD_COMMAND "Server: No command matches your input"
#define LANG_NO_TALK "Server: Please join a room before talking using the /j command.\n"
#define LANG_CHOOSE_ROOM "Server: See a list of rooms using the /r command"
